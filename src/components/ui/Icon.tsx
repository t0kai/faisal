...
/**
 * Icon set as inline paths — no icon library, no runtime cost, no tree-shaking
 * guesswork. Every glyph is 24×24 on a 1.3 stroke for optical consistency.
 */
export const ICONS = {
  ...
  globe: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18ZM3 12h18M12 2.8c2.4 2.6 3.6 5.8 3.6 9.2s-1.2 6.6-3.6 9.2c-2.4-2.6-3.6-5.8-3.6-9.2S9.6 5.4 12 2.8Z',
  ...
  gov: 'M3 21h18M4.5 21V9.5M19.5 21V9.5M9 21V9.5M15 21V9.5M2.5 9.5 12 3.5l9.5 6',
  doc: 'M14.5 3H6.5A1.5 1.5 0 0 0 5 4.5v15A1.5 1.5 0 0 0 6.5 21h11a1.5 1.5 0 0 0 1.5-1.5V7.5L14.5 3ZM14 3v5h5M8.5 13h7M8.5 17h4.5',
  ...
  lng: 'M2.5 17.5h19M4.5 17.5V12l7.5-3 7.5 3v5.5M9 12v5.5M15 12v5.5M12 9V4.5',
  ...
  coal: 'M4 20V9l4-5h8l4 5v11M8 20v-6h8v6M9.5 4v5M14.5 4v5',
  tower: 'M12 2v20M6 6h12M5 10h14M4 21l8-9 8 9',
  waste: 'M4.5 9.5 8 3.5h8l3.5 6M19.5 14.5 16 20.5H8l-3.5-6M8 12h8',
  ...
  user: 'M12 12.3a3.9 3.9 0 1 0 0-7.8 3.9 3.9 0 0 0 0 7.8ZM4.4 20.2c0-4 3.4-6.4 7.6-6.4s7.6 2.4 7.6 6.4',
...
export function Icon({ name, strokeWidth = 1.3, ...rest }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Brand mark. Kept separate because it is filled, not stroked. */
export function Logomark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" fill="none" className={className} aria-hidden="true">
      <rect x=".6" y=".6" width="30.8" height="30.8" rx="7" stroke="var(--line2)" />
      <path d="M17.4 7 9 17.6h5.6L13.8 25 22.2 14.4h-5.6L17.4 7Z" fill="var(--a)" />
    </svg>
  )
}
